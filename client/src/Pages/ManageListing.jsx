  ...
  <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
   ...
   <Section title='Account Metrics'>
         <div className='grid grid-cols-1 md:grid-cols-3 gap-6 mb-6'>
               ...
               <InputField
                  label='Followers Count *' type='number' min={0} 
                  ...
                  required={true}
                   />
                    ...
                    <InputField
                  label='Engagement Rate (%) *' type='number' min={0} max={100} 
                  ...
                  onChange={(v)=> handleInputChange('engagement_rate',v)}
                   />
                    ...
                    <InputField
                  label='Monthly Views/Impression *' type='number' min={0} 
       ...
       <div className='space-y-3'>
          ...
          checked={formData.verified} onChange={(v)=>handleInputChange('verified',v)}/>

           <CheckboxField label="Account is monetized " 
          checked={formData.monetized} onChange={(v)=>handleInputChange('monetized',v)}/>
       </div>
   </Section>
    ...
    <Section title="Pricing & Description">
         <InputField
                  label='Asking Price (USD) '  type='number' min={0}
