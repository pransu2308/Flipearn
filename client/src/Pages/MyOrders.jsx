...
import { Loader2Icon,CheckCircle2, ChevronUp, ChevronDown, Copy } from 'lucide-react';
    ...
    return (
      <div className='px-4 md:px-16 lg:px-24 xl:px-32'>
        <div className='max-w-2xl mx-auto mt-14 bg-white rounded-xl border border-gray-200 p-8 text-center'>
          <h3 className='text-sm text-gray-500 mt-2'>No Orders yet</h3>
                        ...
                        <div className='flex-1'>
                           <div className='flex items-start justify-between gap-4'>
                             <div>
                              ...
                              <p className='tetx-sm text-gray-500 mt-1'>
                             ...
                             <div className='text-right'>
                                <p className='tetx-2xl font-bold'>
                                  {currency}
